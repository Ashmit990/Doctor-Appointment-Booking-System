    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-3">
        <div class="bg-gray-50 rounded-xl p-3">
          ...
          <p class="font-semibold text-gray-800 text-sm">${escHtml(ticket.patient_id || "N/A")}</p>
        </div>
        <div class="bg-gray-50 rounded-xl p-3">
        ...
        <div class="bg-gray-50 rounded-xl p-3">
          <p class="text-xs text-gray-400 mb-1">Cost</p>
      ...
      ${
        ticket.estimated_cost
          ? `<div class="bg-gray-50 rounded-xl p-3">
               <p class="text-xs text-gray-400 mb-1">Estimated Cost (Category Base)</p>
               <p class="text-sm text-gray-700">${formatCurrency(ticket.estimated_cost)}</p>
             </div>`
          : ""
      }
    </div>
