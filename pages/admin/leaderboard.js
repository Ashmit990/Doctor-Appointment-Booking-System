// LEADERBOARD PAGE - DOCTOR RANKINGS
// ====================================
...
function updateSummaryCards() {
  ...
  document.getElementById("stat-platinum").textContent = counts.Platinum;
  document.getElementById("stat-gold").textContent = counts.Gold;
  document.getElementById("stat-silver").textContent = counts.Silver;
  document.getElementById("stat-total").textContent = allDoctors.length;
}
...
function renderTable() {
  ...
  if (!filteredDoctors.length) {
    tbody.innerHTML =
      '<tr><td colspan="7" class="text-center py-10 text-gray-500">No doctors found</td></tr>';
    return;
  }
